...
echo ""
echo "📋 Akun Login:"
echo "  Admin  → admin@smk-almunawwir.sch.id / admin123"
echo "  Guru   → ahmad.fauzi@smk-almunawwir.sch.id / guru123"
echo "  Siswa  → rizky@siswa.smk-almunawwir.sch.id / siswa123"
echo ""
echo "⚠️  Segera ganti password default setelah login pertama!"
