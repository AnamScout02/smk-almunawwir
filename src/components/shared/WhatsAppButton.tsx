...
const WA_NUMBER = "6283878203670";
const WA_MESSAGE = "Assalamualaikum, saya ingin bertanya tentang SMK Al-Munawwir IIBS.";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 p-5 w-72 animate-fade-in">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="font-semibold text-sm text-navy">SMK Al-Munawwir</p>
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 text-white shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center relative"
